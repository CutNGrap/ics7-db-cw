\begin{titlepage}
	...
	\begin{center}
		...
		\Large\textbf{\textsc{"изучение методов ансамблевой обработки изображений на основе ограниченного 
				количества слабых экспертов"}}\\
	\end{center}
	\vspace{3cm}
	...
	\underline{\textnormal{~~~~ Виноградов А.О. ~~~~}}
	...
	\noindent\underline{\textnormal{~~~~Тассов К.Л.~~~~}}
